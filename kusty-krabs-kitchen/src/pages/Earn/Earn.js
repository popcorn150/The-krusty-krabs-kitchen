...
const firstTask = `<img src="/invite.png" alt="invite" class="task__style" />`;
const secondTask = `<img src="/Youtube.png" alt="youtube" class="task__style" />`;
const thirdTask = `<img src="/twitter.png" alt="twitter" class="task__style" />`;
const fouthTask = `<img src="/tiktok.png" alt="tiktok" class="task__style"/>`;
const fifthTask = `<img src="/ig.png" alt="instagram"/>`;
...
export default function Earn() {
    ...
    return (
        <>
            ...
            <h4 className='sub__txt'>Specials</h4>
            <Tasks
                svgIcon1={secondTask}
                title="Check and follow us on our Youtube page"
                subtitle="100,000"
            />
            <Tasks
                svgIcon1={thirdTask}
                title="Check and follow us on our Twitter page"
                subtitle="200,000"
            />
            <Tasks
                svgIcon1={thirdTask}
                title="Check and follow our founder on Twitter"
                subtitle="200,000"
            />
            <Tasks
                svgIcon1={fouthTask}
                title="Check and follow us on our TikTok page"
                subtitle="200,000"
            />
            <Tasks
                svgIcon1={fifthTask}
                title="Check and follow us on our Instagram page"
                subtitle="200,000"
            />
            <Tasks
                svgIcon1={thirdTask}
                title="Repost our latest Tweet on your X page"
                subtitle="100,000"
            />

            <h4 className='sub__txt'>Bonuses</h4>
            <Tasks
                svgIcon1={firstTask}
            ...
            <Tasks
                svgIcon1={firstTask}
                title="Invite 20 of your friends"
                subtitle="300,000"
            />
            <Tasks
                svgIcon1={firstTask}
                title="Invite 50 of your friends"
                subtitle="500,000"
            />
